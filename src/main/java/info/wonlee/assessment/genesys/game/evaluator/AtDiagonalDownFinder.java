...
/**
 * Find 5 in a row at to diagonal from top left to bottom right
 * User: wonlee
 * Date: 25/12/2020
 */

@Component
public class AtDiagonalDownFinder implements InARowFinder {
    @Override
    ...
    private int runThrough(final boolean assent, final int[][] board, final int columnIndex, final int rowIndex) {
        ...
        while(true) {
            ...
            final int ci = columnIndex + (numOfOp * multiplier * -1);
